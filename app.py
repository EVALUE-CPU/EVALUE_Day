...
def get_lottery_data():
    """獲取抽獎名單資料 - 直接在程式中定義"""
    lottery_data = [
        ("頭獎_EVALUE 5萬充電點數", "待抽獎"),
        ("二獎_Sliders電動自行車", "待抽獎"),
        ("三獎_JOWUA電動滑板車", "待抽獎"),
        ("四獎_瑪雅之家住宿券", "待抽獎"),
        ("四獎_瑪雅之家住宿券", "待抽獎"),
        ("五獎_VNW EV系列前擋隔熱紙", "待抽獎"),
        ("五獎_VNW EV系列前擋隔熱紙", "待抽獎"),
        ("六獎_JOWUA雙用行動充電器", "待抽獎"),
        ("七獎_3D 折疊式輪胎桌架", "待抽獎"),
        ("八獎_3D 卡固立體車踏墊", "待抽獎"),
        ("九獎_JOWUA $5500官網購物金", "待抽獎"),
        ("十獎_3D 多功能輪胎梯架", "待抽獎"),
        ("11獎_JOWUA 座椅下摺疊收納盒+超細纖維擦車布", "待抽獎"),
        ("12獎_福斯T1野餐墊", "待抽獎"),
        ("12獎_福斯T1野餐墊", "待抽獎"),
        ("12獎_福斯T1野餐墊", "待抽獎"),
        ("12獎_福斯T1野餐墊", "待抽獎"),
        ("12獎_福斯T1野餐墊", "待抽獎"),
        ("13獎_KIMBLADE 前檔雨刷", "待抽獎"),
        ("13獎_KIMBLADE 前檔雨刷", "待抽獎"),
        ("13獎_KIMBLADE 前檔雨刷", "待抽獎"),
        ("13獎_KIMBLADE 前檔雨刷", "待抽獎"),
        ("13獎_KIMBLADE 前檔雨刷", "待抽獎"),
        ...
        ("13獎_KIMBLADE 前檔雨刷", "待抽獎"),
        ("14獎_保時捷 盾徽紙鎮", "待抽獎"),
        ("15獎_保時捷 Taycan Turbo紙鎮", "待抽獎"),
        ("16獎_3D 萬用木紋摺疊置物箱", "待抽獎"),
        ("17獎_JOWUA 堆疊收納箱30L(兩入)", "待抽獎"),
        ("18獎_保時捷 保溫杯", "待抽獎"),
        ("18獎_保時捷 保溫杯", "待抽獎"),
        ("19獎_Sliders 自行車包", "待抽獎"),
        ("20獎_保時捷 Macan 車型針織袋", "待抽獎"),
        ("20獎_保時捷 Macan 車型針織袋", "待抽獎"),
        ("20獎_保時捷 Macan 車型針織袋", "待抽獎"),
        ("21獎_保時捷 Taycan 車型針織袋", "待抽獎"),
        ("21獎_保時捷 Taycan 車型針織袋", "待抽獎"),
        ("21獎_保時捷 Taycan 車型針織袋", "待抽獎"),
        ("22獎_3D 鋁合金高背摺疊椅", "待抽獎"),
        ("22獎_3D 鋁合金高背摺疊椅", "待抽獎"),
        ("23獎_3D 露營帳篷造型面紙盒套一組(兩個)", "待抽獎"),
        ("23獎_3D 露營帳篷造型面紙盒套一組(兩個)", "待抽獎"),
        ("24獎_車麻吉 $1000停車金", "待抽獎"),
        ("24獎_車麻吉 $1000停車金", "待抽獎"),
        ("24獎_車麻吉 $1000停車金", "待抽獎"),
        ...
        ("24獎_車麻吉 $1000停車金", "待抽獎"),
        ("24獎_車麻吉 $1000停車金", "待抽獎"),
        ("25獎_3D Wildrest兩用托特野餐墊", "待抽獎"),
        ("25獎_3D Wildrest兩用托特野餐墊", "待抽獎"),
        ("26獎_3D Wildrest雙飲保溫瓶", "待抽獎"),
        ("26獎_3D Wildrest雙飲保溫瓶", "待抽獎"),
        ("26獎_3D Wildrest雙飲保溫瓶", "待抽獎"),
        ("27獎_3D 不鏽鋼馬克杯一組(兩個)", "待抽獎"),
        ("27獎_3D 不鏽鋼馬克杯一組(兩個)", "待抽獎"),
        ("28獎_車麻吉 $500停車金", "待抽獎"),
        ("28獎_車麻吉 $500停車金", "待抽獎"),
        ("28獎_車麻吉 $500停車金", "待抽獎"),
