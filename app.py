...
def get_lottery_data():
    ...
    lottery_data = [
        ...
        ("KIMBLADE 前檔雨刷", "28"),
        ("保時捷 盾徽紙鎮", "29"),
        ("保時捷 Taycan Turbo紙鎮", "30"),
        ("3D 萬用木紋摺疊置物箱", "31"),
        ("JOWUA 堆疊收納箱30L(兩入)", "32"),
        ("保時捷 保溫杯", "33"),
        ("保時捷 保溫杯", "34"),
        ("Sliders 自行車包", "35"),
        ("保時捷 Macan 車型針織袋", "36"),
        ...
        ("3D 鋁合金高背摺疊椅", "42"),
        ("3D 鋁合金高背摺疊椅", "43"),
        ("3D 露營帳篷造型面紙盒套一組(兩個)", "44"),
        ("3D 露營帳篷造型面紙盒套一組(兩個)", "45"),
        ("車麻吉 $1000停車金", "46"),
        ("車麻吉 $1000停車金", "47"),
        ("車麻吉 $1000停車金", "48"),
        ("車麻吉 $1000停車金", "49"),
        ...
        ("車麻吉 $1000停車金", "74"),
        ("車麻吉 $1000停車金", "75"),
        ("3D Wildrest兩用托特野餐墊", "76"),
        ("3D Wildrest兩用托特野餐墊", "77"),
        ("3D Wildrest雙飲保溫瓶", "78"),
        ("3D Wildrest雙飲保溫瓶", "79"),
        ("3D Wildrest雙飲保溫瓶", "80"),
        ("3D 不鏽鋼馬克杯一組(兩個)", "81"),
