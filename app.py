...
<div class="main-header">
    ...
    <p>📅 11月29日(六) 10:00-14:00(9點起開始報到)</p>
    <p>📍 苗栗西湖渡假村 幸福廣場</p>
</div>
"""
...
def get_lottery_data():
    ...
    lottery_data = [
        ...
        ("四獎_光辰奈米陶瓷氮化金屬膜", "尚未抽出"),
        ("四獎_光辰奈米陶瓷氮化金屬膜", "尚未抽出"),
        ("五獎_Jowua雙用行動充電器", "尚未抽出"),
        ("六獎_墾丁瑪雅之家住宿券+農場一日遊6人房", "尚未抽出"),
        ("六獎_墾丁瑪雅之家住宿券+農場一日遊6人房", "尚未抽出"),
        ("七獎_3D卡固折疊式輪胎桌架(配送側掛袋)", "尚未抽出"),
        ("八獎_3D卡固立體車踏墊", "尚未抽出"),
        ("九獎_Jowua$5,500購物金", "尚未抽出"),
        ("十獎_NISSANx庫柏力克熊", "尚未抽出"),
        ("十一獎_3D卡固多功能輪胎梯架", "尚未抽出"),
        ("十二獎_德國萊因TUV中古車驗車代金卷", "尚未抽出"),
        ("十三獎_Jowua座椅下摺疊收納盒＋超細纖維擦車布組合", "1363"),
        ("十四獎_元三福斯：原廠野餐墊", "454"),
        ("十四獎_元三福斯：原廠野餐墊", "851"),
        ("十四獎_元三福斯：原廠野餐墊", "554"),
        ("十四獎_元三福斯：原廠野餐墊", "191"),
        ("十四獎_元三福斯：原廠野餐墊", "1127"),
        ("十五獎_德國萊因TUV中古車驗車代金卷", "608"),
        ("十五獎_德國萊因TUV中古車驗車代金卷", "1660"),
        ("十五獎_德國萊因TUV中古車驗車代金卷", "642"),
        ("十五獎_德國萊因TUV中古車驗車代金卷", "1648"),
        ("十五獎_德國萊因TUV中古車驗車代金卷", "438"),
        ("十六獎_PorscheTaycanTurbo紙鎮", "1702"),
        ("十七獎_Porsche保時捷盾徽紙鎮", "570"),
        ("十八獎_3D卡固萬用木紋摺疊置物箱", "875"),
        ("十九獎_Jowua30L堆疊收納箱(兩入)", "1169"),
        ("二十獎_3D卡固航太鋁合金羽量級折疊椅2張", "676"),
        ("二十獎_3D卡固航太鋁合金羽量級折疊椅2張", "600"),
        ("二十一獎_Porsche新竹保時捷保溫杯", "1663"),
        ("二十一獎_Porsche新竹保時捷保溫杯", "1420"),
        ("二十二獎_UKKO3合1無線充+360旋轉座", "918"),
        ("二十二獎_UKKO3合1無線充+360旋轉座", "854"),
        ("二十三獎_賓士手提包黑色", "757"),
        ("二十四獎_賓士手提包灰色", "476"),
        ("二十五獎_UKKO100W氮化鎵3孔智能控溫急充器", "189"),
        ("二十五獎_UKKO100W氮化鎵3孔智能控溫急充器", "292"),
        ("二十六獎_Slider自行車包", "1054"),
        ("二十六獎_Slider自行車包", "1083"),
        ("二十六獎_Slider自行車包", "80"),
        ("二十六獎_Slider自行車包", "1600"),
        ...
        ("二十八獎_PorscheTaycan車型針織袋", "1696"),
        ("二十八獎_PorscheTaycan車型針織袋", "1346"),
        ("二十八獎_PorscheTaycan車型針織袋", "1378"),
        ("二十九獎_德國萊因TUV中古車驗車代金卷", "495"),
        ("二十九獎_德國萊因TUV中古車驗車代金卷", "1571"),
        ("二十九獎_德國萊因TUV中古車驗車代金卷", "210"),
        ("二十九獎_德國萊因TUV中古車驗車代金卷", "900"),
        ("二十九獎_德國萊因TUV中古車驗車代金卷", "1589"),
        ("三十獎_3D卡固露營帳篷造型面紙盒套x2", "1312"),
        ("三十獎_3D卡固露營帳篷造型面紙盒套x2", "1119"),
        ("三十一獎_VolvoMILU造型二合一頸枕", "561"),
        ("三十一獎_VolvoMILU造型二合一頸枕", "1636"),
        ("三十二獎_車麻吉免費停車20小時", "44"),
        ("三十二獎_車麻吉免費停車20小時", "1713"),
        ("三十二獎_車麻吉免費停車20小時", "31"),
        ("三十二獎_車麻吉免費停車20小時", "738"),
        ("三十二獎_車麻吉免費停車20小時", "1753"),
        ("三十二獎_車麻吉免費停車20小時", "901"),
        ("三十二獎_車麻吉免費停車20小時", "1216"),
        ("三十二獎_車麻吉免費停車20小時", "177"),
        ("三十二獎_車麻吉免費停車20小時", "1195"),
        ("三十二獎_車麻吉免費停車20小時", "937"),
        ("三十二獎_車麻吉免費停車20小時", "640"),
        ("三十二獎_車麻吉免費停車20小時", "1361"),
        ("三十二獎_車麻吉免費停車20小時", "979"),
        ("三十二獎_車麻吉免費停車20小時", "859"),
        ("三十二獎_車麻吉免費停車20小時", "1461"),
        ("三十二獎_車麻吉免費停車20小時", "714"),
        ("三十二獎_車麻吉免費停車20小時", "1629"),
        ("三十二獎_車麻吉免費停車20小時", "844"),
        ("三十二獎_車麻吉免費停車20小時", "893"),
        ("三十二獎_車麻吉免費停車20小時", "800"),
        ("三十二獎_車麻吉免費停車20小時", "357"),
        ("三十二獎_車麻吉免費停車20小時", "648"),
        ("三十二獎_車麻吉免費停車20小時", "318"),
        ("三十二獎_車麻吉免費停車20小時", "962"),
        ("三十二獎_車麻吉免費停車20小時", "848"),
        ("三十二獎_車麻吉免費停車20小時", "437"),
        ("三十二獎_車麻吉免費停車20小時", "1329"),
        ("三十二獎_車麻吉免費停車20小時", "1758"),
        ("三十二獎_車麻吉免費停車20小時", "1325"),
        ("三十二獎_車麻吉免費停車20小時", "374"),
        ("三十三獎_3D卡固Wildrest兩用托特野餐墊", "1056"),
        ("三十三獎_3D卡固Wildrest兩用托特野餐墊", "897"),
        ("三十四獎_3D卡固不鏽鋼馬克杯x2", "591"),
        ("三十四獎_3D卡固不鏽鋼馬克杯x2", "1552"),
        ("三十五獎_車麻吉免費停車10小時", "484"),
        ("三十五獎_車麻吉免費停車10小時", "725"),
        ("三十五獎_車麻吉免費停車10小時", "549"),
        ("三十五獎_車麻吉免費停車10小時", "1682"),
        ("三十五獎_車麻吉免費停車10小時", "636"),
        ("三十五獎_車麻吉免費停車10小時", "984"),
        ("三十五獎_車麻吉免費停車10小時", "1499"),
        ("三十五獎_車麻吉免費停車10小時", "983"),
        ("三十五獎_車麻吉免費停車10小時", "316"),
        ("三十五獎_車麻吉免費停車10小時", "1261"),
        ("三十五獎_車麻吉免費停車10小時", "616"),
        ("三十五獎_車麻吉免費停車10小時", "582"),
        ("三十五獎_車麻吉免費停車10小時", "481"),
        ("三十五獎_車麻吉免費停車10小時", "813"),
        ("三十五獎_車麻吉免費停車10小時", "1509"),
        ("三十五獎_車麻吉免費停車10小時", "472"),
        ("三十五獎_車麻吉免費停車10小時", "1104"),
        ("三十五獎_車麻吉免費停車10小時", "1396"),
        ("三十五獎_車麻吉免費停車10小時", "511"),
        ("三十五獎_車麻吉免費停車10小時", "1300"),
        ("三十五獎_車麻吉免費停車10小時", "1098"),
        ("三十五獎_車麻吉免費停車10小時", "660"),
        ("三十五獎_車麻吉免費停車10小時", "850"),
        ("三十五獎_車麻吉免費停車10小時", "1626"),
        ("三十五獎_車麻吉免費停車10小時", "1016"),
        ("三十五獎_車麻吉免費停車10小時", "544"),
        ("三十五獎_車麻吉免費停車10小時", "1117"),
        ("三十五獎_車麻吉免費停車10小時", "653"),
        ("三十五獎_車麻吉免費停車10小時", "421"),
        ("三十五獎_車麻吉免費停車10小時", "781"),
        ("三十五獎_車麻吉免費停車10小時", "1582"),
        ("三十五獎_車麻吉免費停車10小時", "148"),
        ("三十五獎_車麻吉免費停車10小時", "331"),
        ("三十五獎_車麻吉免費停車10小時", "143"),
        ("三十五獎_車麻吉免費停車10小時", "1372"),
        ("三十五獎_車麻吉免費停車10小時", "1495"),
        ("三十五獎_車麻吉免費停車10小時", "1010"),
        ("三十五獎_車麻吉免費停車10小時", "399"),
        ("三十五獎_車麻吉免費停車10小時", "607"),
        ("三十五獎_車麻吉免費停車10小時", "789"),
        ("三十六獎_一級淨除水垢極淨慕斯", "1089"),
        ("三十六獎_一級淨除水垢極淨慕斯", "1053"),
        ("三十六獎_一級淨除水垢極淨慕斯", "707"),
        ("三十六獎_一級淨除水垢極淨慕斯", "354"),
        ("三十七獎_一級淨除油垢極淨噴霧", "940"),
        ("三十七獎_一級淨除油垢極淨噴霧", "469"),
